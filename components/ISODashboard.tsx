...
const ISODashboard: React.FC<ISODashboardProps> = ({ onNavigate }) => {
    ...
    // Performance Optimization: Consolidate 10+ array iterations into a single O(N) loop
    // Avoids redundant passes over `merchants` and prevents call stack size errors from Math.max(...array)
    let atRiskCount = 0;
