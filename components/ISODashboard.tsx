...
const ISODashboard: React.FC<ISODashboardProps> = ({ onNavigate }) => {
    ...
    // Bolt Performance: Consolidate multiple O(N) array operations into a single loop
    let atRiskCount = 0;
    ...
    for (const m of merchants) {
        ...
        if (m.monthlyVolume && m.monthlyVolume > topMerchantVolume) {
            topMerchantVolume = m.monthlyVolume;
        }
