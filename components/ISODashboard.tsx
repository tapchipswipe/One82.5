...
const ISODashboard: React.FC<ISODashboardProps> = ({ onNavigate }) => {
    ...
    // OPTIMIZATION: Combine multiple O(N) array traversals (filter, reduce, map) into a single loop
    // Expected impact: Reduces CPU cycles and memory allocations significantly for large merchant portfolios
    let atRiskCount = 0;
