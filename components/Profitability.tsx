...
const Profitability: React.FC = () => {
  ...
  const profitabilityFreshness = useMemo(() => {
    ...
    // ⚡ Bolt: Consolidated chained map/filter/sort into a single O(N) loop to track the latest timestamp.
    // Impact: Reduces O(N log N) sorting and eliminates unnecessary array allocations for large transaction lists.
