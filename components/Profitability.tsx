...
const Profitability: React.FC = () => {
  ...
  const totals = useMemo(() => {
    // ⚡ Bolt: Consolidated 5 sequential `.reduce()` iterations into a single loop
    // This reduces redundant O(N) traversals to exactly one pass, lowering CPU and memory usage
    let totalVolume = 0;
    let totalMargin = 0;
