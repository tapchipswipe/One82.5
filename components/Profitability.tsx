...
const Profitability: React.FC = () => {
  ...
  const totals = useMemo(() => {
    ...
    // Consolidated 5 consecutive .reduce() calls into a single for loop.
    // Reduces O(N) array iterations from 5 down to 1.
    // Expected Impact: Faster execution time for totals calculation, reducing unnecessary re-renders.
    let totalVolume = 0;
    let totalMargin = 0;
