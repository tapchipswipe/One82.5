...
const Profitability: React.FC = () => {
  ...
  const totals = useMemo(() => {
    ...
    // Bolt optimization: Consolidated 5 sequential .reduce() passes into a single loop.
    // Reduces O(5N) iteration to O(N), improving re-render performance for large datasets.
