...
const Profitability: React.FC = () => {
  ...
  const totals = useMemo(() => {
    // ⚡ Bolt: Consolidated 5 separate .reduce() passes into a single loop
    // Impact: Reduces O(5N) operations to O(N), significantly improving evaluation
    // time when rendering or filtering large data sets of merchants.
    let totalVolume = 0;
    let totalMargin = 0;
