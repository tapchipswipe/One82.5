...
const Profitability: React.FC = () => {
  ...
  const totals = useMemo(() => {
    ...
    // Replaced 5 consecutive O(N) .reduce() operations over `filteredRows` with a single O(N) for loop.
    // This avoids redundant array traversals and speeds up recalculations when the dataset is large.
